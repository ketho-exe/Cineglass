...
Private streaming-style front end powered by TMDB metadata, Supabase Auth/Postgres, and VidKing embeds.
...
VIDKING_DEFAULT_AUTOPLAY=true
VIDKING_DEFAULT_LANGUAGE=en
