    ...
    <article>
      <section className="relative min-h-[520px] overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-900">
        ...
        <div className="relative grid min-h-[520px] gap-8 p-6 sm:grid-cols-[220px_1fr] sm:p-10">
          {poster ? (
            <div className="relative hidden aspect-[2/3] w-full self-end overflow-hidden rounded-3xl shadow-glow sm:block">
              <Image src={poster} alt="" fill sizes="220px" className="object-cover" />
            </div>
          ) : null}
